    ...
    <section className="regular-banner-white flex flex-col items-center px-4 md:px-6 py-12 md:py-16 relative overflow-hidden">
      ...
      <div className="text-center w-full max-w-7xl">
        ...
        <h3
          ...
          style={{ color: "#4B4B4B" }}
        >
          We envision a world where organizations harness agentic AI with confidence—where innovation and control strengthen each other. Mill Pond Research built Xilos as a single platform that manages the entire agentic AI ecosystem—from creation to governance—turning every deployment into a building block for organizational intelligence.
        </h3>
      </div>
