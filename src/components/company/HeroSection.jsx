    ...
    >
      ...
      <div className="absolute top-48 left-0 pointer-events-none" style={{ zIndex: 50 }}>
        ...
        <div
          ...
          style={{
            background: 'radial-gradient(circle, transparent 0%, transparent 35%, rgba(86, 124, 141, 0.08) 40%, rgba(86, 124, 141, 0.05) 45%, rgba(86, 124, 141, 0.03) 50%, transparent 55%)',
          }}
        />
        {/* Ring 2 */}
        <div
          ...
          style={{
            background: 'radial-gradient(circle, transparent 0%, transparent 50%, rgba(86, 124, 141, 0.06) 55%, rgba(86, 124, 141, 0.04) 60%, rgba(86, 124, 141, 0.02) 65%, transparent 70%)',
          }}
        />
        {/* Ring 3 */}
        <div
          ...
          style={{
            background: 'radial-gradient(circle, transparent 0%, transparent 65%, rgba(86, 124, 141, 0.05) 70%, rgba(86, 124, 141, 0.03) 75%, rgba(86, 124, 141, 0.015) 80%, transparent 85%)',
          }}
        />
      </div>
      ...
      {/* Content */}
      <div className="hero-banner-surface flex max-w-4xl flex-col items-center gap-12 text-center z-10">
