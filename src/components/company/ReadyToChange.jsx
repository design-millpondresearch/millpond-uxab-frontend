...
/*
 * The closing call‑to‑action on the company page. We apply responsive
 * padding and adjust the margin on the button to maintain comfortable
 * spacing on mobile devices. Decorative blobs remain unchanged.
 */
