  ...
  return (
    <section className="relative regular-banner-white flex items-center justify-center resources-hero-banner px-4 md:px-6 lg:px-12 py-8 md:py-12 overflow-hidden">
      ...
      >
        ...
        {/* Curved line */}
        <path d="M 0 100 Q 250 0, 500 100 Q 750 310, 1000 220" stroke="none" fill="none" />
        {/* Gradient extending downward for first half */}
        <path d="M 0 100 Q 250 0, 500 100 L 500 400 L 0 400 Z" fill="url(#curveGradientDown)" />
        {/* Gradient extending upward for second half */}
        <path d="M 500 100 Q 750 310, 1000 220 L 1000 0 L 500 0 Z" fill="url(#curveGradientUp)" />
      ...
      <div className="resources-hero-banner-clear flex max-w-4xl flex-col items-center gap-4 md:gap-6 text-center relative z-10">
