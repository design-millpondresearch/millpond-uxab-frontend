        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12">
          ...
          >
            ...
            <p className="small-font" style={{ color: "#4B4B4B" }}>
              The application layer built into Xilos &mdash; professional-grade authoring tools to prototype, test, and deploy agents with universal model compatibility.
            </p>
          </Link>
