...
function HeroSection() {
  return (
    <main className="regular-banner-sand">
      <div className="mx-auto max-w-7xl pt-28 pb-24 text-center">
        <h1
        ...
        <p
          className="subheader mx-auto max-w-5xl text-base md:text-xl lg:text-2xl"
          style={{ color: "#4B4B4B" }}
        >
          Ready to take control of your AI future? Get in touch with our team
          to discover how Mill Pond Research can transform your organization’s
          approach to AI security and orchestration.
        </p>
  useEffect(() => {
